...
#---workflow 1
w1_col_to_drop = list(df_collected.columns[34:94]) + list(df_collected.columns[98:101])
...
#---workflow 2
w2_col_to_drop=list(df_collected.columns[4:34]) + list(df_collected.columns[94:98])
...
# cols_to_drop_final=w2_df_collected.columns[4:72] 
# w2_df_final=w2_df_collected.drop(cols_to_drop_final,axis=1) #drop answers
